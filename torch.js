  ...
  run: [
    ...
    // windows nvidia
    {
      ...
      "params": {
        ...
        "path": "{{args && args.path ? args.path : '.'}}",
        "message": [
          "uv pip install torch==2.4.0 torchvision==0.19.0 torchaudio==2.4.0 {{args && args.xformers ? 'xformers' : ''}} --index-url https://download.pytorch.org/whl/cu124",
    ...
    // windows cpu
    {
      ...
      "params": {
        "venv": "{{args && args.venv ? args.venv : null}}",
        "path": "{{args && args.path ? args.path : '.'}}",
        "message": "uv pip install torch==2.4.0 torchvision==0.19.0 torchaudio==2.4.0 numpy==1.26.4"
      },
      "next": null
    },
    // mac
    ...
    // linux rocm (amd)
    {
      ...
      "params": {
        "venv": "{{args && args.venv ? args.venv : null}}",
        "path": "{{args && args.path ? args.path : '.'}}",
        "message": "uv pip install torch==2.4.0 torchvision==0.19.0 torchaudio==2.4.0 --index-url https://download.pytorch.org/whl/rocm6.0"
      },
      "next": null
    },
    // linux cpu
